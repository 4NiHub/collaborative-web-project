...
const MOCK = {
    ...
    todaySchedule: {
        data: [
            { id: 1, title: 'Data Structures',  type: 'lecture',  time: '09:00', location: 'Room 301, Block A', instructor: 'Dr. Johnson'   },
            { id: 2, title: 'Web Development',  type: 'lab',      time: '11:00', location: 'Lab 3, Block B',    instructor: 'Prof. Chen'    },
            { id: 3, title: 'Database Systems', type: 'tutorial', time: '14:00', location: 'Room 204, Block A', instructor: 'Dr. Rodriguez' }
        ]
    },
        ...
        if (USE_MOCK) {
            return {
                data: [
                    ...
                    { moduleId: 'M5', moduleName: 'Network Security',     attended: 21, total: 22, percentage: 95 },
