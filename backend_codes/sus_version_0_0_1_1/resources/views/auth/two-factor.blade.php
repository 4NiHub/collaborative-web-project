...
<div class="login-container">
    ...
    <form id="otpForm" novalidate>
        ...
        <div class="timer-wrap">
            Code expires in <span id="countdown">10:00</span><br>
    ...
    <div class="divider">SINGLE USE · 10 MINUTES</div>
...
<script>
    ...
    // Countdown
    const expiresAt = {{ session('2fa_expires_at', now()->addMinutes(10)->timestamp) }};
