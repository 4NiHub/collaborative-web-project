    ...
    <main class="main-content">
        ...
        <div class="profile-banner">
            ...
            <div class="profile-banner-info">
                <div class="profile-banner-name" id="profileName">Dr. Sarah Johnson</div>
                <div class="profile-banner-dept" id="profileDept">Computer Science – Smart University System</div>
                <div class="subject-chips" id="subjectChips">
                    <span class="subject-chip">Data Structures</span>
                    <span class="subject-chip">Algorithms</span>
                    <span class="subject-chip">Computational Theory</span>
                </div>
            </div>
            <button class="edit-profile-btn" onclick="alert('Edit Profile feature is in progress 🚀')">Edit Profile</button>
        </div>
