...
<body>
    <div class="app-container">
        ...
        <aside class="sidebar">
            ...
            <div class="sidebar-icons">
                ...
                <div class="sidebar-icon active" data-page="news" data-tooltip="News">
    ...
    <script>
        ...
        async function toggleBookmark() {
            ...
            var isBookmarked = bookmarkedIds.has(String(currentArticleId));
            btn.disabled = true;
            try {
                await NewsAPI.toggleBookmark(currentArticleId);
                if (isBookmarked) {
                ...
                console.error('[News] Bookmark failed:', err.message);
            } finally {
                btn.disabled = false;
            }
        }
        ...
        function renderCards(allArticles) {
            ...
            allArticles.forEach(function(a, idx) {
                ...
                card.innerHTML =
                    '<div class="news-image ' + gradClass + '">' +
        ...
        async function loadNews() {
            ...
            try {
                ...
                if (!allArticles || allArticles.length === 0) {
                    grid.innerHTML = '<div class="state-msg">No news allArticles available at the moment.</div>';
                    return;
                }
         ...
         async function openNewsModal(articleId, gradClass) {
            currentArticleId = articleId;
            document.getElementById('newsModal').classList.add('active');
            var bBtn = document.getElementById('bookmarkBtn');
            if (bookmarkedIds.has(String(articleId))) {
            ...
            try {
                var res = await NewsAPI.getArticle(articleId);
                var a   = res.data;
